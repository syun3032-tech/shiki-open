...
TOOL_LEVELS: dict[str, ToolLevel] = {
    ...
    # WRITE — パス/ホワイトリスト検証付き自動承認
    "open_app": ToolLevel.WRITE,
    "open_url": ToolLevel.WRITE,
    "open_url_with_profile": ToolLevel.WRITE,
    "run_command": ToolLevel.WRITE,
    "move_file": ToolLevel.WRITE,
    # リマインダー
    "add_reminder": ToolLevel.WRITE,
    "list_reminders": ToolLevel.READ,
    "delete_reminder": ToolLevel.WRITE,
    # ブラウザ
    "browse_url": ToolLevel.WRITE,
    "search_web": ToolLevel.WRITE,
    "get_page_text": ToolLevel.READ,
    "get_page_elements": ToolLevel.WRITE,
    "interact_page_element": ToolLevel.WRITE,
    "get_accessibility_tree": ToolLevel.READ,
    "crop_screenshot": ToolLevel.READ,
    # CodeAct
    "execute_code": ToolLevel.WRITE,
    # 計画ツール
    "update_plan": ToolLevel.WRITE,
    # Claude Code委譲
    "delegate_to_claude": ToolLevel.WRITE,
    # Cronジョブ
    "schedule_task": ToolLevel.WRITE,
    "list_scheduled_tasks": ToolLevel.READ,
    "delete_scheduled_task": ToolLevel.WRITE,
    # マルチエージェント
    "dispatch_agents": ToolLevel.WRITE,
    # 動的ツール生成（コード生成のためELEVATED維持）
    ...
    "notion_update_project": ToolLevel.WRITE,
    "notion_create_project": ToolLevel.WRITE,
    "notion_list_tasks": ToolLevel.READ,
    "notion_create_task": ToolLevel.WRITE,
    "notion_update_task": ToolLevel.WRITE,
    "notion_batch_create_tasks": ToolLevel.WRITE,
    "notion_search": ToolLevel.READ,
    "notion_get_page_content": ToolLevel.READ,
    "notion_add_comment": ToolLevel.WRITE,
    "notion_list_comments": ToolLevel.READ,
    "notion_update_block": ToolLevel.WRITE,
    "notion_append_blocks": ToolLevel.WRITE,
    "notion_execute_tasks": ToolLevel.WRITE,
    "notion_execute_single_task": ToolLevel.WRITE,
